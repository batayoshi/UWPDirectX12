#include "pch.h"
#include "UWPDirectX12Main.h"
#include "Common\DirectXHelper.h"

using namespace UWPDirectX12;
...
UWPDirectX12Main::UWPDirectX12Main()
{
...
//レンダラーを作成して、初期化します。
void UWPDirectX12Main::CreateRenderers(const std::shared_ptr<DX::DeviceResources>& deviceResources)
{
...
void UWPDirectX12Main::OnWindowSizeChanged()
{
...
void UWPDirectX12Main::OnSuspending()
{
...
void UWPDirectX12Main::OnResuming()
{
	//TODO: これをアプリの再起動ロジックで置き換えます。
}

// デバイス リソースを解放する必要が生じたことをレンダラーに通知します。
void UWPDirectX12Main::OnDeviceRemoved()
{
